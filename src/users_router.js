...
router.post( '/', (req, res) =>
{
	var sql = create_user_query_string( req.body );
...
{
	var sql = delete_user_query_string( req.body );
...
function create_user_query_string( user )
{
...
function delete_user_query_string( user )
{
